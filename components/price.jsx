...
const PricingSection = () => {
  ...
  return (
    <>
      ...
      {/* Floating Button - Shows when pricing section is out of view */}
      <div
      ...
      >
        ...
        >
          {/* Pulsing glow */}
          <div className="absolute -inset-3 bg-gradient-to-r from-emerald-400 to-teal-400 rounded-full blur-xl opacity-60 animate-pulse"></div>
          
          {/* Main button */}
          <div className="relative bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-8 py-4 rounded-full shadow-2xl hover:shadow-emerald-500/50 transition-all duration-300 hover:scale-110 hover:from-emerald-500 hover:to-teal-500 active:scale-95 flex items-center gap-3 cursor-pointer">
            <span className="font-bold text-lg">Reserve Spot</span>
            <div className="bg-white/20 backdrop-blur-sm rounded-full px-3 py-1">
              <span className="text-sm font-bold">{availableSpots} left</span>
            </div>
          </div>
